...
\begin{frame}{Cluster Patterns: Three Resident Profiles}
    \begin{columns}[T]
        ...
        \begin{column}{0.60\textwidth}
            \centering
            \includegraphics[width=\textwidth,height=0.88\textheight,keepaspectratio]{img/demographic_parallel_plot.png}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Savings Drivers: Household Size vs. Education}
    ...
    \footnotesize
    \begin{itemize}\setlength{\itemsep}{2pt}
        \item Household size shows only minor differences in savings behavior.
        \item Education level shows a clearer pattern: higher education is associated with higher savings and greater financial resilience.
    \end{itemize}
\end{frame}
...
\begin{frame}{City-Wide Employment Context}
    \framesubtitle{Question 3: Employer Health}
    \vspace{4pt}
    \centering
    \includegraphics[width=0.85\textwidth,height=0.72\textheight,keepaspectratio]{img/employment_trends.png}
    
    \vspace{6pt}
    \footnotesize
    Indicates workforce reallocation and churn rather than city-wide employment collapse.
\end{frame}

\begin{frame}{Employer Market Share}
    \framesubtitle{Question 3: Employer Health}
    \vspace{4pt}
    \centering
    \includegraphics[width=0.85\textwidth,height=0.72\textheight,keepaspectratio]{img/market_share.png}
    
    \vspace{6pt}
    \footnotesize
    After the initial workforce shift, top employer concentration remains stable.
\end{frame}

\begin{frame}{Estimated Monthly Payroll}
    \framesubtitle{Question 3: Employer Health}
    \vspace{4pt}
    \centering
    \includegraphics[width=0.95\textwidth,height=0.72\textheight,keepaspectratio]{img/monthly_payroll.png}
    
    \vspace{6pt}
    \footnotesize
    Adds economic scale to the analysis, highlighting the impact of large employers.
\end{frame}
